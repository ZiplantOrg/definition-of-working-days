...
data_object = [
        ...
        ('ep_nso_aif_uk_q_10rd_specdep', 'quart_obj','$par:refPeriodEnd','$par:refPeriodStart','$par:CurrentPeriodEnd','$par:startQuart','$par:startRepYear'),
        ('ep_nso_aif_uk_y_10rd_specdep', 'year_obj','$par:refPeriodEnd','$par:refPeriodStart','$par:CurrentPeriodEnd','$par:startQuart','$par:startRepYear'),
